            ...
            >
              ...
              news.map((item, index) => (
                <SwiperSlide key={index}>
                   <div className='flex flex-col items-center gap-12 mb-10 sm:flex-row sm:justify-between'>
                    {/* news info */}
                    <div className='py-4'>
                    <Link to="/">
                    <h3 className='mb-4 text-lg font-medium hover:text-blue-500'>{item.title}</h3></Link>
